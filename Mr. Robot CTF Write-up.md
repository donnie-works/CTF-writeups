...
![[robot_wplogin_error_username.gif]]
...
![[robot_hydra_username.gif]]

Here I used the -L flag with our wordlist "new.dic" and the -p flag  with "null" as simply a place holder for the password input. The http-post-form data can be surmised from our original Burp Suite request in proxy.

![[robot_hydra_burp_info.gif]]
